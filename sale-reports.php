...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-sm-10">
            ...
            <form action="sale-reports.php" class="form-inline mt-3 mb-3">
                ...
                <button class="btn btn-info ml-3"><i class="fas fa-info-circle"></i>Filter Report</button>

                <button type="reset" class="btn btn-warning ml-3">Clear Fields</button>

            </form>

            <a class="btn btn-sm btn-dark" href="sale-reports.php?start_date=<?=$last_seven?>&end_date=<?=$today?>">Report For last 7 Days</a>
            <a class="btn btn-sm btn-dark" href="sale-reports.php?start_date=<?=$last_thirty?>&end_date=<?=$today?>">Report For last 30 Days</a>
            <a class="btn btn-sm btn-dark" href="sale-reports.php?start_date=<?=$last_fourteen?>&end_date=<?=$today?>">Report For last 2 weeks</a>
            <a class="btn btn-sm btn-dark" href="sale-reports.php?start_date=<?=$last_6_months?>&end_date=<?=$today?>">Report For last 6 months</a>
